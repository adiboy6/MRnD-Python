...
-sets are similar to tuples but here we don't have any duplicate elements in it and they are enclosed withing {}
-the base value when we pass a dictionary is the key values and if specify dict_name.value(), then it represents the values present in that key
-many operations can be performed on the sets just like the operations performed in "Mathematical Sets"
"""
