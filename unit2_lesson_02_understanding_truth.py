...
def test_truth_values():
    assert ' is treated as false' ==truth_test("", "")
...
-the default value for 0 is false and 1 is true while testing theere equivalence
-list,sets,tuples,discts and strings are all false when empty
-None is as similar to NULL in any other language*c,C++,JAVA,PHP)
"""
