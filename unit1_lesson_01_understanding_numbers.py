...
def test_numbers_arithmetic_operations():
    ...
    # >>> import math
    # >>> help(math.isclose)
    assert math.isclose(2.33, 7 / 3, abs_tol=0.0033333333333334103), "fix abs_tol so that this assert passes"
...
-division of negative numbers in python leads to greatest rounded off no.(i.e-1.33~2)
-anything whose base is greater than that of 10 will be considered from 10(ie, 1,2,3,4,5,6,7,8,9,a,b....)
