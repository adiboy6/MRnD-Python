...
-they're immutable but the they can be be updated in another tuple
-string conversion to tuple or list and by using join, we get the concatenated tuple i.e, string
-each value can be accessed by using the number of elements in tuple (a,b=tuple(10,20))
"""
