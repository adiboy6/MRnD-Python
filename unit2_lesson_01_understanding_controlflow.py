...
-break can even break out from the for-else or while-else
-string comparision is automatically done unlike in C we use strcmp or a loop to check each character 
"""