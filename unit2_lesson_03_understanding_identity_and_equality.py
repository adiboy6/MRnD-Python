...
-I found out that id's of small no. and None is always the same for 2 varialbes
-'==' is used to find the equivalence of the value present in that variable
-'is' is used to find the equivalence of their id's
"""
