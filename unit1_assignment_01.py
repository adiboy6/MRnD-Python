...
def get_multiples_desc(number, count):
    ...
    lists lesson.
    """
    return list(range(number*count,number-1,-number))
...
def base36_to_binary(input):
    ...
    NOTE:int(x,base)-x is the input and base starts from 2-36(i.e,binary,..)-o/p is the value of that input in integer[(1,1),(2,),(3,3....(A,10),...(Z,35)
    """
