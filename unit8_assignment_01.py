...
import time
from unit8_conversion_methods import numbers_string1,numbers_string2,numbers_string3,num_strings4
...
def profile_perf_counter():
    for i in [10,100,1000,10000]:
        print("numbers_string1,", "count=", i, end=" ")
        l=[]
        for j in range(5):
            numbers_string1(i)
            l.append(time.clock())
        print("min=",min(l),"actuals=",l)
    for i in [10,100,1000,10000]:
        print("numbers_string2,", "count=", i, end=" ")
        l=[]
        for j in range(5):
            numbers_string2(i)
            l.append(time.clock())
        print("min=",min(l),"actuals=",l)
    for i in [10,100,1000,10000]:
        print("numbers_string3,", "count=", i, end=" ")
        l=[]
        for j in range(5):
            numbers_string3(i)
            l.append(time.clock())
        print("min=",min(l),"actuals=",l)
    for i in [10,100,1000,10000]:
        print("num_strings4,", "count=", i, end=" ")
        l=[]
        for j in range(5):
            num_strings4(i)
            l.append(time.clock())
